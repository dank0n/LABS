...
namespace WindowsFormsApp8
{
    public partial class Form5 : Form
    {
        ...
        {
            if (buttons[1, 1].Text == "" && firstTurn == 0)
            {
                buttons[1, 1].Text = "O";
                firstTurn = 1;
            ...
            else if (buttons[0, 0].Text == "" && firstTurn == 0)
            {
                buttons[0, 0].Text = "O";
                firstTurn = 1;
            ...
            else if (secondTurn == 0 && buttons[1,1].Text == "X")
            {
                if(buttons[2, 2].Text == "X")
                {
                    buttons[0, 2].Text = "O";
                    buttons[0, 2].GetType().GetProperty("Enabled").SetValue(buttons[0, 2], false);
                    player = 1;
            ...
            else if (buttons[0,1].Text == "X" && secondTurn == 0)
            {
                buttons[0, 0].Text = "O";
                buttons[0, 0].GetType().GetProperty("Enabled").SetValue(buttons[0, 0], false);
                player = 1;
            ...
            else if (buttons[2, 1].Text == "X" && secondTurn == 0)
            {
                buttons[2, 2].Text = "O";
                buttons[2, 2].GetType().GetProperty("Enabled").SetValue(buttons[2, 2], false);
                player = 1;
            ...
            else if (buttons[1, 2].Text == "X" && secondTurn == 0)
            {
                buttons[2, 2].Text = "O";
                buttons[2, 2].GetType().GetProperty("Enabled").SetValue(buttons[2, 2], false);
                player = 1;
